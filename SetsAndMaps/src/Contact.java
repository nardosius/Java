...
public class Contact {
    ...
    public Contact(String name) {//constructor for name only, email null
        this(name, null);
    }

    public Contact(String name, String email) {
        this(name, email, 0);//constructor for name and email, phone = 0
    }
    public Contact(String name, long phone) {//constructor for name and phone, email == null
        this(name, null, phone);
    }

    public Contact(String name, String email, long phone) {
        this.name = name;//constructor for name, email and phone
        if (email != null) {
            emails.add(email);
        }
        if (phone > 0) {
