...
public class Main {
    public static void main(String[] args) {
        ...
        Set<Contact> emailContacts = new HashSet<>(emails);//set created from a List<>
        ...
        intersectAB.retainAll(phoneContacts);//symmetric operation
        ...
        printData("Symmetric Defference: phones and emails", symmetricDiff2);
